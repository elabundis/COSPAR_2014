...
\begin{subcolumns}
	...
	\block{}{
		...
		\node (cap1) [below=0cm of rgna,xshift=2.7em,yshift=1.5em] {caption1};
		\vspace{1em}
	  %
		\node (itrf) [below=1cm of cap1,xshift=2.7em,yshift=0em]
			{
				\includegraphics[width=0.20\textwidth]{Figures/ITRF_2020.png}
			};
		\node (cap2) [below=0cm of itrf,xshift=2.7em,yshift=1.5em] {caption2};
	  %		
		\vspace{1em}
	} 
	% Right column images
	...
	\block{}{
		\begin{center}
			...
			\node (cap3) [below=0cm of gps,xshift=2.7em,yshift=1.5em] {caption3};
		\end{center}
		\vspace{1em}
		%
		\node (vlbi) [below=0cm of cap3,xshift=2.7em,yshift=2.0em] {
				\includegraphics[width=0.20\textwidth]{Figures/VLBI_stations_proposal.png}
		};
		\node (cap4) [below=0cm of vlbi,xshift=2.7em,yshift=1.5em] {caption4};
		\vspace{26em}
		%
	}
\end{subcolumns}
