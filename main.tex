...
\block{}{
	...
	\node (cap7) [below=0cm of fringes,xshift=2.7em,yshift=1.5em] {\textbf{Fig. 7}};
	\vspace{14em}
	%
}
...
\begin{subcolumns}
	...
	\block{}{
		\begin{tikzfigure}
			...
			\node (cap8) [below=0cm of vis1,xshift=2.7em,yshift=1.5em] {\textbf{Fig. 8}};
		\end{tikzfigure}
	} 
	% Right column image
	\subcolumn{0.5} 
	\block{}{
		\begin{tikzfigure}
			...
			\node (cap9) [below=0cm of vis2,xshift=2.7em,yshift=1.5em] {\textbf{Fig. 9}};
		\end{tikzfigure}
		\vspace{11em}
	}
\end{subcolumns}
