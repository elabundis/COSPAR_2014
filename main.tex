...
\begin{subcolumns}
    \subcolumn{0.30} 
		\block{}{
			\begin{tikzpicture}
				\draw[ultra thick, -{Stealth[length=5mm]}] (0,0) -- (0,8)
					node[anchor=east]{z};
				\draw[ultra thick, -{Stealth[length=5mm]}] (0,0) -- (8,0) 
					node[anchor=north east]{y};
				\draw[ultra thick, -{Stealth[length=5mm]}] (0,0) -- (-4,-4) 
					node[anchor=north west]{x};
				\draw[-{Stealth[length=4mm]}] (0,0) -- (5.2,4.0) 
					node[circle, draw, inner sep=0pt, minimum width=5mm] (A) {}
					node[anchor=north east,xshift=-1cm]{$a$}
					-- (8.49, 5.20);
				\draw (0,0) -- (5.2,-3.0) 
					node[anchor=north west]{$Q^n_z$};
			\end{tikzpicture}
		} 
    \subcolumn{0.70} 
			\block{}{
