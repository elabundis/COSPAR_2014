\documentclass[a0paper, 20pt, margin=1in, innermargin=-1.7in, blockverticalspace=-0.25in, portrait]{tikzposter}
    ...
    \subcolumn{0.32} 
		\block{}{
			\begin{tikzpicture}[
				...
				% Fig label
				\normalsize
				\node (vlbi-scheme) [below=0cm of x-axis, xshift=5em, yshift=-1.3em] {\textbf{Fig. 5}}; 
			\end{tikzpicture}
		} 
    \subcolumn{0.68} 
			\block{}{
