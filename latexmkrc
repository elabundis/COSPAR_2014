...
# Compilation
# ------------------------------
# generate pdf using the pdflatex engine
$pdf_mode = 1;
...
$bibtex_use = 1.5;
# Other extensions to delete during cleanup (-c and -C)
$clean_ext = "ccf";
# Other extensions to delete during full cleanup (-C)
$clean_full_ext = "fdb_latexmk"
